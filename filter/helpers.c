...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 1; i < height - 1; i++)
    {
        for (int j = 1; j > 0 && j < width - 1; j++)
        {
            ...
            for (int k = i - 1; count < 3; k++, count++)
            {
                int count2 = 0;
                for (int f = j - 1; count2 < 3; f++, count2++)
                {
    ...
    for (int j = 1; j < width - 1; j++)
    {
        ...
        for (int k = height - 2; count < 2; k++, count++)
        {
            int count2 = 0;
            for (int f = j - 1; count2 < 3; f++, count2++)
            {
    ...
    for (int i = 1; i < height - 1; i++)
    {
        ...
        {
            int count2 = 0;
            for (int f = width - 2; count2 < 2; f++, count2++)
            {
                int red = image[k][f].rgbtRed;
                cumR += red;
    ...
    for (k = 0, count = 0, cumR = 0, cumG = 0, cumB = 0; count < 2; k++, count++)
    {
        int count2 = 0;
        for (int f = 0; count2 < 2; f++, count2++)
        {
    ...
    //Corners lower right
    for (k = height - 2, count = 0, cumR = 0, cumG = 0, cumB = 0; count < 2; k++, count++)
    {
        int count2 = 0;
        for (int f = width - 2; count2 < 2; f++, count2++)
        {
